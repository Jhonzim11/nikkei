...
export const products: Product[] = [
  { id: 101, name: 'Raquete Pro Staff', category: 'Raquetes', price: 899.90, imageUrl: '/images/products/raquete-pro-staff.jpg', rating: 5, reviewCount: 128, tags: ['Novo'], description: 'A raquete de escolha dos profissionais, a Pro Staff oferece controle e sensibilidade incomparáveis. Construída com grafite trançado para uma sensação pura e clássica. Ideal para jogadores de nível avançado que buscam precisão em cada golpe.' },
